      ...
      if (!in_array($key, $ignore_columns))
      {
        ...
        switch ($key)
        {
          ...
          default:
            ...
            {
              if (isset($user->{$key}) && isset($select_options["user.$key"][$user->{$key}]))
              {
