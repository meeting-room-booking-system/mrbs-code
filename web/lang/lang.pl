...
$vocab["areas"]              = "Strefy";
$vocab["now_day"]            = "Dzisiaj";
$vocab["now_week"]           = "Dzisiaj";
$vocab["now_month"]          = "Dzisiaj";
$vocab["now_year"]           = "Dzisiaj";
...
$vocab["too_many_entries"]   = "Wybrana opcja utworzy zbyt wiele wpisów.<br>Proszę użyć innego wyboru!";
...
$vocab["earliest_booking_date"]   = "Najwcześniejszy termin rezerwacji to %s";
$vocab["latest_booking_date"]     = "Najpóźniejszy termin rezerwacji to %s";
$vocab["max_booking_duration"]    = 'Maksymalny czas trwania pobytu to %1$d %2$s';
...
$vocab["policy_length"]      = "%d cyfr";
$vocab["policy_alpha"]       = "%d liter";
$vocab["policy_lower"]       = "%d małych liter";
$vocab["policy_upper"]       = "%d dużych liter";
$vocab["policy_numeric"]     = "%d cyfr";
$vocab["policy_special"]     = "%d znaków specjalnych";
$vocab["action"]             = "Akcja";
