...
$vocab["confirmdel"]         = "Είστε βέβαιοι ότι θέλετε να διαγράψετε αυτή την εγγραφή;";
...
$vocab["users_db.name"]          = "Όνομα Χρήστη";
$vocab["users_db.password"]      = "Κωδικός Πρόσβασης";
$vocab["users_db.level"]         = "Rights";
...
$vocab["users_db.email"]         = "Email address";
