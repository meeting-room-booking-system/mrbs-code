...
$vocab["user.name"]          = "Имя";
$vocab["user.password"]      = "Пароль";
$vocab["user.level"]         = "Права";
...
//$vocab["user.name"]         = Use the same как above, for consistency.
//$vocab["user.password"]     = Use the same как above, for consistency.
$vocab["user.email"]         = "адрес электронной почты";
