...
$vocab["goto"]               = "перейти";
$vocab["nav_day"]            = "День";
$vocab["nav_week"]           = "Неделю";
$vocab["nav_month"]          = "Месяц";
...
$vocab["confirmdel"]          = "Вы уверены в том что Вы хотите удалить эту запись?";
...
$vocab["too_many_entries"]   = "Выбранные опции создадут слишком много записей.<br>Пожалуйста выберите другие опции!";
...
$vocab["mail_subject_approved"]  = "Запись утверждена %s "; // $mrbs_company
$vocab["mail_subject_rejected"]  = "Запись отклонена %s "; // $mrbs_company
$vocab["mail_subject_more_info"] = "%s : запрошена более подробная информация"; // $mrbs_company
$vocab["mail_subject_reminder"]  = "Напоминание для %s "; // $mrbs_company
...
$vocab["mail_subject_new_entry"]     = "Запись добавлена %s "; // $mrbs_company
$vocab["mail_subject_changed_entry"] = "Запись изменена %s "; // $mrbs_company
$vocab["mail_subject_delete"]        = "Запись удалена %s "; // $mrbs_company
...
$vocab["users_db.name"]          = "Имя";
$vocab["users_db.password"]      = "Пароль";
$vocab["users_db.level"]         = "Права";
...
$vocab["contact_admin"]            = "Если у Вас нет прав администрирования, свяжитесь с администратором %s."; // $mrbs_admin
...
//$vocab["users_db.name"]         = Use the same как above, for consistency.
//$vocab["users_db.password"]     = Use the same как above, for consistency.
$vocab["users_db.email"]         = "адрес электронной почты";
...
$vocab["policy_length"]      = "%d символ(ов)";
$vocab["policy_alpha"]       = "%d символ(ов)";
$vocab["policy_lower"]       = "%d символ(ов) в нижнем регистре";
$vocab["policy_upper"]       = "%d символ(ов) в верхнем регистре";
$vocab["policy_numeric"]     = "%d числовых символ(ов)";
$vocab["policy_special"]     = "%d специальных символ(ов)";
