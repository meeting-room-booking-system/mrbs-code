    ...
    tableOptions.buttons = [
      ...
      },
      {
        ...
        action: function (e, dt, node, config) {
          ...
          const data = $('#search_form').serializeArray();
          ...
          $.post({
            ...
            success: function(blob, status, xhr) {
              ...
              let matches = contentType.match(contentTypeRegex);
              const type = (matches === null) ? '' : matches[0];
              let filename = "";
              ...
              if (typeof window.navigator.msSaveBlob !== 'undefined') {
                ...
                const downloadUrl = URL.createObjectURL(new Blob([blob], {type: type}));
