...
function get_date_heading(string $view, int $year, int $month, int $day) : string
{
  ...
  switch ($view)
  {
    ...
    case 'week':
      ...
      if ($view_week_number && ($weekstarts == DateTime::firstDayOfWeek($timezone, Language::getInstance()->getMrbsLocale())))
      {
      ...
      $ranger = new Ranger(Language::getInstance()->getMrbsLocale());
      $ranger
    ...
    case 'year':
      $ranger = new YearRanger(Language::getInstance()->getMrbsLocale());
