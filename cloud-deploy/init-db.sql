-- Create MRBS database and user
CREATE DATABASE IF NOT EXISTS mrbs CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
CREATE USER IF NOT EXISTS 'mrbs_user'@'%' IDENTIFIED BY 'mrbs-db-user-2025';
GRANT ALL PRIVILEGES ON mrbs.* TO 'mrbs_user'@'%';
FLUSH PRIVILEGES;

USE mrbs;

-- Include the tables.my.sql content
#
